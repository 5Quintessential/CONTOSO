...
{
    public sealed partial class TrendingHero : UserControl
    {
        public Lib.Models.Restaurant TrendingRestaurant
        {
            get { return (Lib.Models.Restaurant)GetValue(TrendingRestaurantProperty); }
            set { 
                SetValue(TrendingRestaurantProperty, value); 
            }
        }

        public static readonly DependencyProperty TrendingRestaurantProperty =
            DependencyProperty.Register("TrendingRestaurant", typeof(Lib.Models.Restaurant), typeof(TrendingHero), new PropertyMetadata(null));
